...
plot(x, y1, '-ob', 'LineWidth', 2, 'MarkerFaceColor', 'b');
hold on;

plot(x, y2, '-sr', 'LineWidth', 2, 'MarkerFaceColor', 'r');

% Vertical offset values
offset1 = 5;        % offset for Algorithm A labels
offset2 = 1;      % offset for Algorithm B labels

% Add labels to points
for i = 1:length(x)

    % Labels for Algorithm A
    text(x(i), y1(i) + offset1, ...
